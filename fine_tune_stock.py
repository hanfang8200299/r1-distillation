...
# 加载预训练模型和分词器
model = "model/unsloth/Qwen2.5-7B-Instruct-unsloth-bnb-4bit"
print("Model loaded: "+model)
model, tokenizer = FastLanguageModel.from_pretrained(
    model_name = model, # 指定模型名称
...
print(f"Time elapsed：{execution_time} s")